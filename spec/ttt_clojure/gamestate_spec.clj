...
(describe "xs-turn?"
  (it "should evaluate the given gamestate and return true if its x's turn and false if not"
    (should= true  (xs-turn? {:movelist [] :board [:- :- :- :- :- :- :- :- :-]}))
    (should= true  (xs-turn? {:movelist [] :board [:x :o :x :o :- :- :- :- :-]}))
    (should= true  (xs-turn? {:movelist [] :board [:x :o :x :o :o :- :- :- :-]}))
    (should= false (xs-turn? {:movelist [] :board [:x :o :x :o :x :- :- :- :-]}))))
